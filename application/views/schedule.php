...
<div class="modal fade appointment_info" id="message" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header" style="background-color: #a82721; margin: -20px; height: 45px;">
                <button type="button" class="close" 
                   data-dismiss="modal">
                       <span aria-hidden="true" style="margin-right: 10px;color: white;">&times;</span>
                       <span class="sr-only">Close</span>
                </button>
                <h3 class="modal-title bold" id="myModalLabel" style='margin-left: 15px; color: #fff; margin-top: -10px;'>
                    Appointment
                </h3>
            </div>
        ...
        <div class="modal-footer">
			<button class="btn btn-default cancel-appointment appointment_buttons" id="CANCELLED">
				Cancel Appointment
			</button>
        </div>
    </div>
