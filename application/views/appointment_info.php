	...
	{	
		...
		if($edit == false)
		{
			...
			elseif($ai->status == "APPROVED")
			{
					...
					<a href='";						
						echo base_url();
						echo "index.php/home/cancel_appointment?id=$ai->id' onclick='return confirm(\"Are you sure you want to cancel this appointment?\")'>
						<button>
							Cancel Appointment
						</button>
					</a>
...
<tr>
	<td align="center">
		<button type="button" id="edit_button" onClick="edit_schedule()" class="btn btn-default">Edit</button>
		<button type="button" onClick="schedule_popup_close()" class="btn btn-default">Close</button>
	</td>
</tr>
</table>
</form>
