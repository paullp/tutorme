...
class CI_Email {
	...
	var	$smtp_host		= "smtpout.europe.secureserver.net";    // SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "no-reply@tutorme.com.tw";		// SMTP Username
	var	$smtp_pass		= "Tutormesupport123";		// SMTP Password
